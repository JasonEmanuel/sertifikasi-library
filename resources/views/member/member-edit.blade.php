...
<body class="bg-gray-100 text-gray-800">
    <div class="container mx-auto p-4">
        ...
        <form action="{{ route('members.update', $member->id) }}" method="POST" class="bg-white p-6 rounded-lg shadow-lg max-w-lg mx-auto">
            @csrf
            @method('PUT')
            <!-- Name -->
            <div class="mb-4">
            ...
            <div class="flex justify-end">
                <a href="{{ route('members.index') }}" class="bg-gray-500 text-white px-4 py-2 rounded hover:bg-gray-600 mr-2">
                    Cancel
                </a>
